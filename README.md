...
This project is FairPlay Streaming Key Security Module written in Go (Golang) with forked from [easonlin404/ksm](https://github.com/easonlin404/ksm).
...
```bash
$ go get github.com/Cooomma/ksm-golang
```
